...
class TestProxyServer(TestBase):
    ...
    def do_login(self):
        ...
        self.helper.dynamicCall(LoginSession.login, username=credentials['username'], password=credentials['password'])
    ...
    def test_startProxy(self):
        ...
        try:
            ...
            sleep(1)
            rslt = self.helper.dynamicCall(LoginSession.login, username='bad', password='bad')
